...
import { ProfileCompanyInformationSerialization } from './profile-company-information.serialization';
...
export class ProfileInformationSerialization extends Profile {
  ...
  get companyInfo() {
    ...
    return new ProfileCompanyInformationSerialization(this.company, this.lang);
  }
}
