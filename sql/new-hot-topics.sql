...
VALUES (1,3,460,'Influencer','https://hi-job-app-upload.s3.ap-southeast-1.amazonaws.com/images/hot-topics/influencer.png','https://hi-job-app-upload.s3.ap-southeast-1.amazonaws.com/images/hot-topics/web/influencer.png',1,'categories.id = 460',3,1,'2023-06-24 04:15:06','2023-10-06 10:37:29'),
...
INSERT INTO `hot_topics`(title, web_image, theme_id, query, `order`)
VALUES("Restaurant Service", "https://hi-job-app-upload.s3.ap-southeast-1.amazonaws.com/images/hot-topics/web/restaurantservice.png",2,"categories.parentCategory.id=3",7),
("Parttime", "https://hi-job-app-upload.s3.ap-southeast-1.amazonaws.com/images/hot-topics/web/parttime.png",2,"posts.jobType=2",8),
("Marketing", "https://hi-job-app-upload.s3.ap-southeast-1.amazonaws.com/images/hot-topics/web/marketing.png",2,"ccategories.parentCategory.id=6",8),
("Beauty", "https://hi-job-app-upload.s3.ap-southeast-1.amazonaws.com/images/hot-topics/web/beauty.png",2,"categories.parentCategory.id=9",8);
...
;
ALTER TABLE hot_topics DROP KEY `unique_hot_topics`;
ALTER TABLE hot_topics MODIFY COLUMN `type` tinyint(4) DEFAULT NULL;
ALTER TABLE hot_topics MODIFY COLUMN `detail_id` int(11) DEFAULT NULL;
